...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Add Notification Actions to NotificationCategory
        let quizCategory = UNNotificationCategory(identifier: "myNotificationCategory", actions: [answerOne, answerTwo, clue], intentIdentifiers: [], options: [])
